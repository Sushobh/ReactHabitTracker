...
import { getCategoryList } from 'app/redux/actions/EcommerceActions'
...
import { addCategory, addProductCall } from 'app/redux/actions/EcommerceActions'
import VariantItemTable from './VariantItemTable'
                        ...
                        {({
                            ...
                            <ValidatorForm onSubmit={handleSubmit} onError={() => null}>
                                ...
                                <Grid container spacing={6}>
                                    ...
                                    <Grid item xs={12}>
                                        <div color='#abc123' className="mb-6 w-full">
                                            <VariantItemTable
                                                values={values}
